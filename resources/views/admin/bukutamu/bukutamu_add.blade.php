                ...
                <form method="POST" action="{{route('bukutamu.store')}}">
                    ...
                    <div class="row">
                        <div class="col">
                          ...
                          <input type="text" class="form-control" placeholder="Nama Tamu" name="namatamu">
                        </div>
                        <div class="col">
                          <label for="jabatan">Jabatan Tamu</label>
                          <input type="text" class="form-control" placeholder="Jabatan Tamu" name="jabatantamu">
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="col">
                          ...
                          <input type="text" class="form-control" placeholder="Maksud & Tujuan" name="tujuan">
                        </div>
                    </div>
                    <br>
                    <div>
